...
run_step "v0.2 build" make -C variants/v0.2-legacy-intp-baseline clean all
...
run_step "v3 load/attach test" make -C variants/v3-ebpf-ring test
run_step "v3.2 build" make -C variants/v3.2-ebpf-core clean all
